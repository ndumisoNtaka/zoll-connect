      ...
      <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
        {mode === "signin" && (
          <>
            ...
            <p className="text-sm mt-4 text-center">
              ...
              <button className="text-green-700 underline hover:text-green-800" onClick={() => setMode("signup")}>
                Sign Up
              </button>
            </p>
          </>
        ...
        {mode === "signup" && (
          <>
            ...
            <p className="text-sm mt-4 text-center">
              ...
              <button className="text-green-700 underline hover:text-green-800" onClick={() => setMode("signin")}>
                Sign In
              </button>
            </p>
          </>
        ...
        {mode === "verify" && (
          <>
            ...
            <p className="text-sm mt-4 text-center">
              Didn&apos;t receive it?{" "}
              <button className="text-green-700 underline hover:text-green-800">Resend Code</button>
            </p>
          </>
        )}
      </div>
